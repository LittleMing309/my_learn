<template>
    <div>
                            ...
                            <li v-for="(item,index) in cartList" :key="index">
                                <div class="cart-tab-1">
                                    <div class="cart-item-check">
                                        <a
                                            href="javascipt:;"
                                            class="checkbox-btn item-check-btn check"
                                        >
                                    ...
                                    <div class="cart-item-pic">
                                        <img :alt="item.productName" :src="'/static/img/'+item.productImage">
                                    </div>
                                ...
                                <div class="cart-tab-5">
                                    <div class="cart-item-opration">
                                        ...
                                        @click="delCartConfig(item.productId)">
        ...
        <modal :mdShow="modalConfig" @close="closeModal">
            <p slot="message">你确定要删除此条商品吗？</p>
            <div slot="btnGroup">
                <a href="javascript:;" class="btn btn--m" @click="delCart">确认</a>
                <a href="javascript:;" class="btn btn--m" @click="modalConfig = false">关闭</a>
            </div>
        </modal>
