        ...
        <div class="store-content">
            <div class="cart-box">
                ...
                <div class="cart-inner">
                    <div class="empty-label" v-if="totleCount<=0">
                        <h3>您的购物车中还没有商品</h3>
                                    ...
                                    <div class="cart-items">
                                        ...
                                        <div class="item-cols-num">
                                            <div class="select js-select-quantity">
                                                ...
                                                <span class="up" 
                                                :class="{'up-disabled': item.count >= item.limit_num}" @click="plusCarPanelDataHandle(item.sku_id)"
                                                >+</span>
                ...
                <div class="cart-bottom-bg fix-bottom" v-if="totleCount>0">
...
<script>
    ...
    export default {
        computed: {
            ...
            ...mapGetters(['totleCount','allChecked','checkedPrice','checkedCount'])
        },
        methods: {
            ...mapMutations({
                delCarPanelHandle: 'delCarPanelData',
                plusCarPanelDataHandle: 'plusCarPanelData',
                subCarPanelDataHandle: 'subCarPanelData',
                checkGoodsHandle: 'checkGoods',
                allCheckedHandle: 'allChecked',
                allCheckGoodsHandle: 'allCheckGoods',
                delCheckGoodsHandle: 'delCheckGoods'
            })
        }
    }
</script>
