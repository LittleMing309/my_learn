        ...
        <div class="content page-order-payment">
            <div class="gray-box clear">
                ...
                <div class="box-inner payment-checkout-panel clear">
                    <span class="jianguo-blue-main-btn big-main-btn js-payment-order" @click="payNowHandle(orderInfo.orderId)" v-if="!orderInfo.isPay">
                        <a>现在支付</a>
                    </span>
            ...
            <div class="confirm-detail">
                ...
                <p class="info-detail">详细地址：{{orderInfo.receiveInfo.province}}{{orderInfo.receiveInfo.city}}{{orderInfo.receiveInfo.county}}</p>
            </div>
            <div class="confirm-detail">
            ...
            <div class="order-discount-line">
                <p> 商品总计： <span>¥ {{orderInfo.price + orderInfo.freight}}.00</span> </p>
